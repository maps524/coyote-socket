...
<select
  class={cn(
    'flex h-10 w-full rounded-md border border-input bg-background text-foreground pl-3 pr-10 py-2 text-sm ring-offset-background appearance-none focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
    className
  )}
  bind:value
  {...$$restProps}
